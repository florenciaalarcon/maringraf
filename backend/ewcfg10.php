...
define("EW_PROJECT_NAME", "maringraf", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{6DDC98FA-D568-4216-A349-71F4D51B4AA0}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'SZ32MvxcC68Bpbiq', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/maringraf.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_DB", 'maringraf', TRUE);
...
define("EW_ADMIN_PASSWORD", "654321", TRUE); // Administrator password
