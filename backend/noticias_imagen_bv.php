...
$noticias_imagen_blobview = NULL; // Initialize page object first

class cnoticias_imagen_blobview extends cnoticias {
...
// Create page object
if (!isset($noticias_imagen_blobview)) $noticias_imagen_blobview = new cnoticias_imagen_blobview();
