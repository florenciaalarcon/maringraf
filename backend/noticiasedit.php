...
fnoticiasedit.Lists["x_idCategoria"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_denominacion","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
ew_CreateCalendar("fnoticiasedit", "x_fecha", "%d/%m/%Y");
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateEditor("fnoticiasedit", "x_contenido", 35, 4, <?php echo ($noticias->contenido->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<script type="text/javascript">
fnoticiasedit.Lists["x_idCategoria"].Options = <?php echo (is_array($noticias->idCategoria->EditValue)) ? ew_ArrayToJson($noticias->idCategoria->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<input type="hidden" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($noticias->id->CurrentValue) ?>">
