...
class cnoticias extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('noticias', 'noticias', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// contenido
		$this->contenido = new cField('noticias', 'noticias', 'x_contenido', 'contenido', '`contenido`', '`contenido`', 201, -1, FALSE, '`contenido`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['contenido'] = &$this->contenido;

		// imagen
		$this->imagen = new cField('noticias', 'noticias', 'x_imagen', 'imagen', '`imagen`', '`imagen`', 200, -1, TRUE, '`imagen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['imagen'] = &$this->imagen;

		// idCategoria
		$this->idCategoria = new cField('noticias', 'noticias', 'x_idCategoria', 'idCategoria', '`idCategoria`', '`idCategoria`', 3, -1, FALSE, '`idCategoria`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
