...
$productos_imagen_blobview = NULL; // Initialize page object first

class cproductos_imagen_blobview extends cproductos {
	...
	// Page object name
	var $PageObjName = 'productos_imagen_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('productos', 'x_imagen');
...
// Create page object
if (!isset($productos_imagen_blobview)) $productos_imagen_blobview = new cproductos_imagen_blobview();

// Page init
$productos_imagen_blobview->Page_Init();

// Page main
$productos_imagen_blobview->Page_Main();
?>
<?php
$productos_imagen_blobview->Page_Terminate();
?>
