...
<?php if ($productos->titulo->Visible) { // titulo ?>
		<td><span id="elh_productos_titulo" class="productos_titulo"><?php echo $productos->titulo->FldCaption() ?></span></td>
<?php } ?>
<?php if ($productos->imagen->Visible) { // imagen ?>
		<td><span id="elh_productos_imagen" class="productos_imagen"><?php echo $productos->imagen->FldCaption() ?></span></td>
<?php } ?>
<?php if ($productos->precio->Visible) { // precio ?>
		<td><span id="elh_productos_precio" class="productos_precio"><?php echo $productos->precio->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $productos_delete->RowCnt ?>_productos_titulo" class="control-group productos_titulo">
...
<span id="el<?php echo $productos_delete->RowCnt ?>_productos_imagen" class="control-group productos_imagen">
...
<span id="el<?php echo $productos_delete->RowCnt ?>_productos_precio" class="control-group productos_precio">
