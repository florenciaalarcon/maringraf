...
class cproductos extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('productos', 'productos', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// titulo
		$this->titulo = new cField('productos', 'productos', 'x_titulo', 'titulo', '`titulo`', '`titulo`', 200, -1, FALSE, '`titulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['titulo'] = &$this->titulo;

		// imagen
		$this->imagen = new cField('productos', 'productos', 'x_imagen', 'imagen', '`imagen`', '`imagen`', 200, -1, TRUE, '`imagen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['imagen'] = &$this->imagen;

		// detalle
		$this->detalle = new cField('productos', 'productos', 'x_detalle', 'detalle', '`detalle`', '`detalle`', 201, -1, FALSE, '`detalle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['detalle'] = &$this->detalle;

		// precio
		$this->precio = new cField('productos', 'productos', 'x_precio', 'precio', '`precio`', '`precio`', 5, -1, FALSE, '`precio`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
