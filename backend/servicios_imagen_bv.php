...
$servicios_imagen_blobview = NULL; // Initialize page object first

class cservicios_imagen_blobview extends cservicios {
...
// Create page object
if (!isset($servicios_imagen_blobview)) $servicios_imagen_blobview = new cservicios_imagen_blobview();
