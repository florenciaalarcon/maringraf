...
// Form object
var fserviciosadd = new ew_Form("fserviciosadd");
...
fserviciosadd.ValidateRequired = true;
<?php } else { ?>
fserviciosadd.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="fserviciosadd" id="fserviciosadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="servicios">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_serviciosadd" class="table table-bordered table-striped">
