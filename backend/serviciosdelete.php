...
// Form object
var fserviciosdelete = new ew_Form("fserviciosdelete");
...
fserviciosdelete.ValidateRequired = true;
<?php } else { ?>
fserviciosdelete.ValidateRequired = false; 
<?php } ?>
...
?>
<form name="fserviciosdelete" id="fserviciosdelete" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<table id="tbl_serviciosdelete" class="ewTable ewTableSeparate">
<?php echo $servicios->TableCustomInnerHtml ?>
	<thead>
	<tr class="ewTableHeader">
<?php if ($servicios->imagen->Visible) { // imagen ?>
		<td><span id="elh_servicios_imagen" class="servicios_imagen"><?php echo $servicios->imagen->FldCaption() ?></span></td>
<?php } ?>
<?php if ($servicios->titulo->Visible) { // titulo ?>
		<td><span id="elh_servicios_titulo" class="servicios_titulo"><?php echo $servicios->titulo->FldCaption() ?></span></td>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $servicios_delete->RowCnt ?>_servicios_imagen" class="control-group servicios_imagen">
<span<?php echo $servicios->imagen->ViewAttributes() ?>>
<?php if ($servicios->imagen->LinkAttributes() <> "") { ?>
<?php if (!empty($servicios->imagen->Upload->DbValue)) { ?>
<?php echo $servicios->imagen->ListViewValue() ?>
...
<span id="el<?php echo $servicios_delete->RowCnt ?>_servicios_titulo" class="control-group servicios_titulo">
<span<?php echo $servicios->titulo->ViewAttributes() ?>>
<?php echo $servicios->titulo->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
