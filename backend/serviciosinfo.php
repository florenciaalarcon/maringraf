...
class cservicios extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('servicios', 'servicios', 'x_id', 'id', '`id`', '`id`', 19, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// imagen
		$this->imagen = new cField('servicios', 'servicios', 'x_imagen', 'imagen', '`imagen`', '`imagen`', 200, -1, TRUE, '`imagen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['imagen'] = &$this->imagen;

		// titulo
		$this->titulo = new cField('servicios', 'servicios', 'x_titulo', 'titulo', '`titulo`', '`titulo`', 200, -1, FALSE, '`titulo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['titulo'] = &$this->titulo;

		// texto
		$this->texto = new cField('servicios', 'servicios', 'x_texto', 'texto', '`texto`', '`texto`', 201, -1, FALSE, '`texto`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("serviciosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("serviciosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "serviciosadd.php";
	}
