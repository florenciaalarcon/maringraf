...
class cservicios_list extends cservicios {
	...
	function BasicSearchSQL($Keyword) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->texto, $Keyword);
		return $sWhere;
	}
	...
	function RenderOtherOptions() {
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->CustomActions as $action => $name) {
				...
				$item->Body = "<a class=\"ewAction ewCustomAction\" href=\"\" onclick=\"ew_SubmitSelected(document.fservicioslist, '" . ew_CurrentUrl() . "', null, '" . $action . "');return false;\">" . $name . "</a>";
			}
...
// Form object
var fservicioslist = new ew_Form("fservicioslist");
...
fservicioslist.ValidateRequired = true;
<?php } else { ?>
fservicioslist.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
// Form object for search

var fservicioslistsrch = new ew_Form("fservicioslistsrch");
</script>
<script type="text/javascript">
...
<?php if ($servicios_list->ExportOptions->Visible()) { ?>
<div class="ewListExportOptions"><?php $servicios_list->ExportOptions->Render("body") ?></div>
<?php } ?>
<?php
...
<form name="fservicioslistsrch" id="fservicioslistsrch" class="ewForm form-inline" action="<?php echo ew_CurrentPage() ?>">
<table class="ewSearchTable"><tr><td>
<div class="accordion" id="fservicioslistsrch_SearchGroup">
	<div class="accordion-group">
		<div class="accordion-heading">
<a class="accordion-toggle" data-toggle="collapse" data-parent="#fservicioslistsrch_SearchGroup" href="#fservicioslistsrch_SearchBody"><?php echo $Language->Phrase("Search") ?></a>
		</div>
		<div id="fservicioslistsrch_SearchBody" class="accordion-body collapse in">
			<div class="accordion-inner">
<div id="fservicioslistsrch_SearchPanel">
...
<div id="xsr_1" class="ewRow">
	...
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="input-large" value="<?php echo ew_HtmlEncode($servicios_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo $Language->Phrase("Search") ?>">
	<button class="btn btn-primary ewButton" name="btnsubmit" id="btnsubmit" type="submit"><?php echo $Language->Phrase("QuickSearchBtn") ?></button>
	</div>
	</div>
	<div class="btn-group ewButtonGroup">
	<a class="btn ewShowAll" href="<?php echo $servicios_list->PageUrl() ?>cmd=reset"><?php echo $Language->Phrase("ShowAll") ?></a>
</div>
<div id="xsr_2" class="ewRow">
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="="<?php if ($servicios_list->BasicSearch->getType() == "=") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("ExactPhrase") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="AND"<?php if ($servicios_list->BasicSearch->getType() == "AND") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AllWord") ?></label>
	<label class="inline radio ewRadio" style="white-space: nowrap;"><input type="radio" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="OR"<?php if ($servicios_list->BasicSearch->getType() == "OR") { ?> checked="checked"<?php } ?>><?php echo $Language->Phrase("AnyWord") ?></label>
</div>
</div>
</div>
			</div>
...
<!--first page button-->
	...
	<a class="btn btn-small" href="<?php echo $servicios_list->PageUrl() ?>start=<?php echo $servicios_list->Pager->FirstButton->Start ?>"><i class="icon-step-backward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" disabled="disabled"><i class="icon-step-backward"></i></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($servicios_list->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $servicios_list->PageUrl() ?>start=<?php echo $servicios_list->Pager->PrevButton->Start ?>"><i class="icon-prev"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" disabled="disabled"><i class="icon-prev"></i></a>
	<?php } ?>
<!--current page number-->
	<input class="input-mini" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $servicios_list->Pager->CurrentPage ?>">
<!--next page button-->
	<?php if ($servicios_list->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $servicios_list->PageUrl() ?>start=<?php echo $servicios_list->Pager->NextButton->Start ?>"><i class="icon-play"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" disabled="disabled"><i class="icon-play"></i></a>
	<?php } ?>
<!--last page button-->
	<?php if ($servicios_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-small" href="<?php echo $servicios_list->PageUrl() ?>start=<?php echo $servicios_list->Pager->LastButton->Start ?>"><i class="icon-step-forward"></i></a>
	<?php } else { ?>
	<a class="btn btn-small" disabled="disabled"><i class="icon-step-forward"></i></a>
	<?php } ?>
</div>
	&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $servicios_list->Pager->PageCount ?>
</td>
<td>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $servicios_list->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $servicios_list->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $servicios_list->Pager->RecordCount ?>
</td>
</tr></tbody></table>
<?php } else { ?>
...
<form name="fservicioslist" id="fservicioslist" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="servicios">
<div id="gmp_servicios" class="ewGridMiddlePanel">
<?php if ($servicios_list->TotalRecs > 0) { ?>
<table id="tbl_servicioslist" class="ewTable ewTableSeparate">
...
<?php if ($servicios->imagen->Visible) { // imagen ?>
	<?php if ($servicios->SortUrl($servicios->imagen) == "") { ?>
		<td><div id="elh_servicios_imagen" class="servicios_imagen"><div class="ewTableHeaderCaption"><?php echo $servicios->imagen->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $servicios->SortUrl($servicios->imagen) ?>',1);"><div id="elh_servicios_imagen" class="servicios_imagen">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $servicios->imagen->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($servicios->imagen->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($servicios->imagen->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php if ($servicios->titulo->Visible) { // titulo ?>
	<?php if ($servicios->SortUrl($servicios->titulo) == "") { ?>
		<td><div id="elh_servicios_titulo" class="servicios_titulo"><div class="ewTableHeaderCaption"><?php echo $servicios->titulo->FldCaption() ?></div></div></td>
	<?php } else { ?>
		<td><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $servicios->SortUrl($servicios->titulo) ?>',1);"><div id="elh_servicios_titulo" class="servicios_titulo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $servicios->titulo->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($servicios->titulo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($servicios->titulo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></td>
	<?php } ?>
<?php } ?>		
<?php
...
<a id="<?php echo $servicios_list->PageObjName . "_row_" . $servicios_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($servicios->titulo->Visible) { // titulo ?>
